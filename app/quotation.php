...
class quotation extends Model
{
    ...
    public function createQuotation($organization_id,$income_id,$lastid,$QTID){
        $unixTimeStamp = Carbon::now()->toDateTimeString();
        DB::connection('mysql')->insert("INSERT INTO `quotation`(`organization_id`, `income_id`, `quotation_id`, `created_at`, `updated_at`,`qt_id` ) VALUES (?,?,?,?,?,?)",
        [$organization_id,$income_id,$lastid,$unixTimeStamp,$unixTimeStamp,$QTID]);
