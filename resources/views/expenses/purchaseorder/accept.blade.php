...
function preview(expenses_id){
            ...
            $.ajax({
               ...
               success:function(data) {
                ...
                $("#modalfooter").append("<a onclick=\"return accept()\" href=\"{{url('expenses/purchaseorder/accept/')}}/"+expenses_id+"\" class=\"btn btn-primary mr-2\">อนุมัติใบเสนอราคา</a><button type=\"button\" class=\"btn btn-secondary cancel\" data-dismiss=\"modal\">ยกเลิก</button>");
