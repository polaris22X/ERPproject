...
<div class="container mt-5 shadow p-5 mb-5 bg-white rounded">
    ...
    <a href="{{url('income/quotation/show/pdf/'.$detail->invoice_id)}}" class="btn btn-primary" style="float: right">สร้างเอกสาร PDF</a>
    @endforeach
    ...
    <div class="row" class="mx-3 mt-2" >
        ...
        <div class="col-3 border border-dark ">
            <div class="ml-2 my-4">
                @foreach ($details as $detail)
                <p style="font-size: 16px">หมายเลขใบสั่งซื้อ : {{$detail->invoice_id}} </p>
