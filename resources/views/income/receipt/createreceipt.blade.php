...
function preview(income_id){
            $.ajax({
               ...
               success:function(data) {
                ...
                $("#modalfooter").append("<a href=\"{{url('income/receipt/')}}/"+income_id+"\" class=\"btn btn-primary mr-2\">ออกใบเสร็จ</a><button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">ยกเลิก</button>")
                }
            });
}
</script>
